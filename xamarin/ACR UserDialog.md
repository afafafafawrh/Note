...
public static string DefaultCancelText { get; set; }
public static DateTimeKind DefaultUnspecifiedDateTimeKindReplacement { get; set; }
public static int? DefaultAndroidStyleId { get; set; }
...
public iOSPickerStyle? iOSPickerStyle { get; set; }
```
...
UserDialogs.Instance.Alert(result.SelectedDate.ToString());
```

# TimePromptConfig & property
...
UserDialogs.Instance.Alert(result.SelectedTime.ToString());
